...
class GenerationMixin:
    ...
    def generate(
        ...
        img_relevance_decoding: Optional[bool] = False,
        img_relevance_penalty: Optional[float] = 1.0,
        **kwargs,
        ...
        if is_greedy_gen_mode and opera_decoding:
            ...
            if img_relevance_decoding:
                
                # 13. run opera beam search with img relevance decoding
                return self.opera_beam_search_img_relevance(
                    input_ids,
                    beam_scorer,
                    logits_processor=logits_processor,
                    stopping_criteria=stopping_criteria,
                    ...
                    num_attn_candidates=num_attn_candidates, 
                    penalty_weights=penalty_weights,
                    img_relevance_penalty=img_relevance_penalty,
                    img_relevance_opposite=img_relevance_opposite,
                    **model_kwargs,
                )
    ...
    def opera_beam_search_img_relevance(
        self,
        input_ids: torch.LongTensor,
        beam_scorer: BeamScorer,
        logits_processor: Optional[LogitsProcessorList] = None,
        ...
        **model_kwargs,
        ...
        while True:
            ...
            penalty_scores = - attn_scores if cur_response_lens <= 10 else attn_scores * img_relevance_penalty + rollback_scores # [batch_size * num_beams, num_attn_candidates]
