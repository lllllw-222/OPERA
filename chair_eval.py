...
for img_id in tqdm(range(len(img_files))):
    ...
    # dump metric file
    with open(os.path.join(base_dir, 'opera-s_{}-t_{}-num_can_{}-p_{}.jsonl'.format(args.scale_factor, args.threshold, args.num_attn_candidates, args.penalty_weights)), "a") as f:
